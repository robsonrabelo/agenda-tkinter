...
btn_adicionar = Button(janela, text="Adicionar", fg="navy", bg="white", font="Tahoma 12 bold",
                       width=8, command=adicionarContato)
btn_adicionar.grid(row=3, column=0)
btn_editar = Button(janela, text="Editar", fg="navy", bg="white", font="Tahoma 12 bold",
                    width=8, command=editarContato)
btn_editar.grid(row=3, column=1)
btn_excluir = Button(janela, text="Excluir", fg="navy", bg="white", font="Tahoma 12 bold",
                     width=8, command=excluirContato)
